...
//   return (
//     <section className="techinfo bg-white pt-10 px-5">
//       <div className="text">
...
//           </div>
//         </div>
//         <div className="mainsection text-xl text-gray-800 mt-10">
//           <h3>Back End</h3>
//           <div className="itemsList flex flex-wrap gap-5 py-5 justify-start">
...
const webFrameworks = {
  ...
  export default function TechInfo() {
    return (
      <section className="techinfo bg-white py-10 px-5">
     <div className="text">
         <h3 className=" text-6xl font-bold ">The tech behind our products</h3>
         <p className="text-gray-700 mt-5 text-[16px] font-semibold">
           Our team of experts is proficient in a wide range of technologies,
