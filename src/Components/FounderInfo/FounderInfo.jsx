export default function Founder(props) {
    return(       
        <section className="founder lg:px-56 flex justify-center items-center flex-col px-5 pt-20  lg:flex lg:flex-row-reverse lg:justify-center lg:items-center">
            <div className='lg:w-[600px] lg:min-w-[400px] '>
