export default function Clients() {
    return (
        <section className="lg:max-w-[73%]  max-w-7xl mx-auto px-6 py-12 lg:mx-[12%] bg-white-100">
            ...
            <div className="flex flex-wrap -mx-2">
                {[
                    ...
                    <div key={index} className="  w-1/2 sm:w-1/3 md:w-1/4 lg:w-[30%]lg:p-5 px-2 mb-4">
                        <div className="bg-white shadow-md p-4 rounded-lg flex justify-center items-center w-full h-24">
                            <img className="max-h-16 lg:p-8 md:max-h-20 lg:max-h-24" src={src} alt="Client Logo" />
                        </div>
                    </div>
                ))}
            </div>
