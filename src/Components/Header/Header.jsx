                ...
                <div className="menu lg:flex hidden lg:py-5 lg:font-semibold justify-between lg:items-end lg:w-3/1 relative">
                    {menuLinks.map((link) => (
                        <div className="relative group" key={link.name}>
                            <a className="hover:text-red-600 lg:m-2 transition-all duration-300 lg:py-5 px-2" href={link.href}>
                                {link.name}
                            </a>
                        </div>
                    ))}
            ...
            {isLoggedOutModalOpen && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                    <div className="bg-white p-6 rounded-lg shadow-lg w-96 text-center">
                        <h2 className="text-lg font-semibold text-gray-900">You have been logged out</h2>
